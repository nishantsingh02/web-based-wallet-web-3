...
function App() {
  ...
  <p className="text-xs mt-1">Designed and Developed by <a src className="font-bold text-indigo-900 hover:text-indigo-500 hover:underline cursor-pointer transition-colors" >Nishant Singh</a></p>
</div>
